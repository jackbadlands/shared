...
function love.load()
	...
	local function drawcb(uiobj, data, absx, absy, w, h)
		love.graphics.setColor(data.r, data.g, data.b, data.a)
		love.graphics.rectangle("fill", absx, absy, w, h)
		return true
	end
...
function love.draw()
	st.screenwidget:draw(0, 0, 0, 0, love.window.getWidth(), love.window.getHeight())
end
